...
class NewsController extends Controller
{
    ...
    public function getPage(Request $request)
    {
        ...
        $col = array('id', 'code','category_newss_id', 'image', 'status', 'name', 'description', 'create_by', 'update_by', 'created_at', 'updated_at');

        $orderby = array('', 'code', 'category_newss_id','image', 'status', 'name', 'description', 'create_by');
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $Item->code = $id;
            $Item->category_newss_id = $request->category_newss_id;
