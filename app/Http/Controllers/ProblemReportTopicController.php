...
class ProblemReportTopicController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $Item = new ProblemReportTopic();
            $prefix = "#PR-";
            $id = IdGenerator::generate(['table' => 'problem_report_topics', 'field' => 'code', 'length' => 9, 'prefix' => $prefix]);
            $Item->code = $id;
     ...
     *
     * @param  \App\Models\ProblemReportTopic  $problemReportTopic
     * @return \Illuminate\Http\Response
     */
    public function show($id)
    {
        $Item = ProblemReportTopic::find($id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(ProblemReportTopic $problemReportTopic)
    {
        //
    }
