...
class CreateMemberDetailAgentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('member_detail_agents', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('member_detail_agents');
    }
}
