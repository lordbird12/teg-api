...
class CreateMemberDetailCompaniesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('member_detail_companies', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('tax')->nullable(); // เลขที่เสียภาษี
    ...
    {
        Schema::dropIfExists('member_detail_companies');
    }
}
