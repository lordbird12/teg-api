...
class CreateTransportThaiMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transport_thai_masters', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('transport_thai_masters');
    }
}
